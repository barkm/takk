 ...
 * with the head at `head` down the frame. */
function frame({ width = 0.3, centre = 0.5, head = 0.2 } = {}): Float32Array {
  ...
  put(SHOULDERS[0], centre + width / 2, 0.4);
  put(SHOULDERS[1], centre - width / 2, 0.4);
